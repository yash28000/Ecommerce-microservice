        ...
        <>
            ...
            <div className="grid grid-cols-2 items-center justify-center px-20 gap-10 w-full h-full">
                ...
                <div className="flex flex-col items-start justify-center">
                    <h1 className="text-4xl font-semibold capitalize my-2">{data.name}</h1>
                    <span className="flex items-center gap-2">
                        <p className="text-xl font-extralight">Rs.{data.price}</p>
                        <p className="text-xl font-extralight line-through text-red-500">Rs.{Number(data.price) + 100}</p>
                    </span>
                    <p className="italic my-2 text-md">deleiver within 7 days of order.</p>
