        ...
        <form className="flex items-center gap-10">
            ...
            <div className="px-10 max-w-lg">
                <span className="flex items-center gap-3 my-2">
                    ...
                    <input placeholder={userDetails.username} name="username" id="username" className="py-3 px-2 text-black w-full outline outline-1 outline-gray-200 bg-transparent"/>
                </span>
                <span className="flex items-center gap-3 my-2">
                    <label htmlFor="email">
                        Email
                    </label>
                    <input placeholder={userDetails.email} name="email" id="email" className="py-3 px-2 text-black w-full outline outline-1 outline-gray-200 bg-transparent"/>
                </span>
